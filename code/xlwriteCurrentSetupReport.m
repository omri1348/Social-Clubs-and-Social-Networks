function xlwriteCurrentSetupReport(filename, data, sheetId, nAgents, nClubs)
...
%     hRange = hSheet.Range('D1:D10,D1:O1,A1:B9,B1,A11:B14,B11,A16:B20,B15');
    hRange = hSheet.Range([rangeMembmapTitles ',A1:B21']);
...
%     hRange = hSheet.Range('D1:O1,D1:D10,A2:A9,A12:A15,A18:A20');
    hRange = hSheet.Range([rangeMembmapTitles ',A2:A21']);
    hRange.Interior.Pattern = 1; %xlSolid
    hRange.Interior.Color = 12566463; % Gray
    % Color Blue:
    hRange = hSheet.Range('A1,A12,A17');
